...
class LaravelLogViewProvider implements ICRUDViewProvider
{
    ...
    {
        return LaravelLogMetaData::instance();
    }

    function getWidgetsViewName()
    {
        return BladeCRUDViewProvider::getThemeViewName('dashboard.pages.laravel-log');
    }
