...
<div class="{{ isset($item['classes.class']) ? $item['classes.class']: null }} mg-t-10 mg-b-10" id="{{ $id }}">
    <div class="card card-customer-overview {{ isset($item['classes.color']) ? $item['classes.color']: 'bg-info' }}" id="{{ $id }}-card">
        <div class="card-header">
            <h6 class="slim-card-title text-white">{{ isset($item['options']['label']) ? $item['options']['label']:'' }}</h6>
